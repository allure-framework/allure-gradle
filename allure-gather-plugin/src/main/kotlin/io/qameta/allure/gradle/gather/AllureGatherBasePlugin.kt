...
import io.qameta.allure.gradle.gather.AllureGatherBasePlugin.Companion.ALLURE_RAW_RESULT_ELEMENTS_CONFIGURATION_NAME
 ...
 */
open class AllureGatherBasePlugin : Plugin<Project> {
    companion object {
        const val PLUGIN_NAME = "io.qameta.allure-gather-base"
    ...
    override fun apply(target: Project): Unit = target.run {
        ...
        allureExtension.extensions.create<AllureGatherExtension>(
            AllureGatherExtension.NAME,
            project,
