...
import io.qameta.allure.gradle.gather.autoconfigure.AutoconfigureRule
import io.qameta.allure.gradle.gather.autoconfigure.AutoconfigureRuleBuilder
import io.qameta.allure.gradle.gather.autoconfigure.DefaultAutoconfigureRuleBuilder
...
open class AdapterConfig @Inject constructor(
    ...
    allureGatherExtension: AllureGatherExtension
) {
    /**
    ...
    val adapterVersion = objects.property<String>()
        .conv(allureGatherExtension.allureJavaVersion)
    ...
    val autoconfigureListeners = objects.property<Boolean>()
        ...
        .conv(
            enabled.map { it && allureGatherExtension.autoconfigureListeners.get() }
        )
